# Batting_Data_2023_Average_Strike_Rates_By_Countries.py
# Importing pandas library
import pandas as pd

# Reading the csv file
df=pd.read_csv('C:/Users/rajja/OneDrive/Desktop/batting_data_2011.csv')
...
myvar=pd.DataFrame({"Country":Lj,"SR":T,"No. Of Players":S,"Average SR":K})

myvar.to_csv("batting_2011_Average_Strike_Rates.csv")
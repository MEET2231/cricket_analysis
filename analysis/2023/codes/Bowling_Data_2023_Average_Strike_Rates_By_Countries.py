...
df=pd.read_csv('Final_Codes_With_Comments/bowling_data_2023.csv')
...
# List of countries
L=['Australia', 'Pakistan', 'England' ,'Sri Lanka' ,'India', 'Afghanistan', 'Bangladesh', 'South Africa' ,'New Zealand', 'Netherlands']
...
myvar.to_csv('Bowling_Data_2023_Average_Strike_Rates_By_Countries.csv', index=False)
